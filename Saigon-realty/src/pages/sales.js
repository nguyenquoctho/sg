...
class Sales extends React.Component {
  ...
  handleFilter() {
    ...
    this.props.listCompanySaleHouses({
      ...params,
  ...
  async changePage(page) {
    ...
    this.props.listCompanySaleHouses({ ...this.props.query, page: parseInt(page) });
  }
  async componentDidMount() {
    await this.props.loadAllDevicesRentPage();
    this.props.setHeaderMenu({ header: 2 });
    let params = queryString.parseUrl(window.location.href).query;
    // Load all houses
    let query = {};
    let page = 1;
    ...
    await this.props.listCompanySaleHouses(this.props.query);
  }
  render() {
          ...
          <div className="container d-flex flex-column">
            ...
            <div className="more-filter-items row d-flex justify-content-between">
              ...
              <div className="col-12 col-md-6 col-md-6">
                ...
                >
                  <FormattedMessage id="furnishment">
                    {(txt) => <option value="">{txt}</option>}
                  </FormattedMessage>
...
const mapDispatch = (dispatch) => ({
  ...
  listCompanySaleHouses: dispatch.houses.listCompanySaleHouses,
